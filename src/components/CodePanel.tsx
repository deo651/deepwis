...
export function CodePanel({ schema }: Props) {
  ...
  return (
    <div className="relative h-full overflow-auto rounded-xl border border-paper-border bg-white shadow-soft">
      <div className="sticky top-0 z-10 flex items-center justify-between border-b border-paper-border bg-white/95 px-3 py-2 backdrop-blur">
